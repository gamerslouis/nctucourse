    ...
    return <Container>
        ...
        <Paper style={{ padding: theme.spacing(5) }}>
            <div style={{ marginBottom: theme.spacing(3) }}>
                ...
                <Typography>
                    1. 登入交大註冊組 <Link href="https://regist.nctu.edu.tw/">學籍成績系統</Link><br />
                    2. 點選「歷年成績查詢」按鈕 (<Link href={gpa_teach1}>範例</Link>)<br />
                    3. 全選 (ctrl+a) 成績內容，並複製貼至下方表單 (<Link href={gpa_teach2}>範例</Link>)<br />
                </Typography>
