                  ...
                  <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
                    <div style={{ width: '240px' }}>
                      <FormControlLabel label="顯示當學期未送註冊組課程"
                        control={<Switch size="small" checked={(this.state.controlFlag & 0b01) > 0} onChange={evt => {
                          this.setState({ controlFlag: (this.state.controlFlag & 0b110) | (evt.target.checked ? 0b001 : 0b000), collapseUnsavedChange: true })
                        }} />}
                      />
                      ...
                      <FormControlLabel label="自動平衡每欄高度"
                        control={<Switch size="small" checked={(this.state.controlFlag & 0b100) > 0} onChange={evt => {
                          this.setState({ controlFlag: (this.state.controlFlag & 0b011) | (evt.target.checked ? 0b100 : 0b000), collapseUnsavedChange: true }, () => {
